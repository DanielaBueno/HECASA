...
<nav>
    ...
    <header>
        ...
        <div class="btn-contenedor">
            ...
            <a href="editar-ejemplar-ad.php?id=<?= htmlspecialchars($ejemplar['id_ejemplar']); ?>">
                <button class="btn_detalles">📝 Editar</button> 
            </a> 

            <form class="btn_eliminar" method="post" onsubmit="return confirm('¿Estás seguro de eliminar este ejemplar?');">   
                <?php
                    include "PHP/editar-eliminar-ejemplarFUNTION.php";
                ?>
                <input type="hidden" name="id" value="<?= $ejemplar['id_ejemplar']; ?>">
                <input class="btn_detalles" type="submit" name="eliminar" value="🗑️ Eliminar">
            </form>
        </div>
    </header>
